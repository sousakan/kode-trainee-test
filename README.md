...
| Написание плана задач | 2 |
| Первоначальная подготовка проекта (скачивание необходимых библиотек, создание конфигов для линтеров и форматтеров, и т. д.) | 0,5 |
| Изучение backend API и создание TS интерфейсов и типов для данных | - |
| Написание модуля api для работы с backend через axios | - |
| Компонент поиска | - |
| Компонент карточки на главной | - |
| Компонент скелетона карточки на главной | - |
| Компонент табов | - |
